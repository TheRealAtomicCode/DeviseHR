...
namespace OP.Services.OperatorServices
{
    public class OperatorService : IOperatorService
    {
        ...
        {
            return await _repository.GetAllAsync(filter: string.IsNullOrWhiteSpace(name) ? null : op => op.GetFullName().Contains(name), pageNumber: pageNumber,pageSize: pageSize );
        }
