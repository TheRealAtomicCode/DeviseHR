...
const TopNav = ({ toggleDarkMode, isDarkMode }: TopNavProps) => {
  return (
    <div
      className={`fixed w-full sm:w-[calc(100%-4rem)] transition-all duration-300 bg-white dark:bg-slate-900`}
    >
      <div className="flex items-center justify-between px-4">
        ...
        <div className="relative flex items-center my-2 rounded-2xl w-1/3 bg-secondary">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="h-10 bg-gray-100 dark:bg-gray-800 placeholder-text pl-8 pr-4 rounded-3xl w-full focus:outline-none"
          />
        </div>
