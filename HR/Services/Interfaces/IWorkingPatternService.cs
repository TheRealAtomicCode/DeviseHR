...
namespace HR.Services.Interfaces
{
    public interface IWorkingPatternService
    {
        ...
        Task<List<EmployeeWithContractDto>> GetWorkingPatternEmployees(int workingPatternId, string? searchTerm, int? page, int? skip, int myId, int companyId, int myRole, bool enableShowEmployees);
